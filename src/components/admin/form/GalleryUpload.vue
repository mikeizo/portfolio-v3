  ...
  <div>
    ...
    >
      ...
      <button
        ...
        class="inline-flex items-center gap-2 rounded-md border border-hairline-input px-3 py-2 text-sm text-ink transition-colors hover:bg-row-hover disabled:cursor-not-allowed disabled:opacity-50"
        @click="inputEl?.click()"
      >
        <Upload :size="14" />
        Select images
